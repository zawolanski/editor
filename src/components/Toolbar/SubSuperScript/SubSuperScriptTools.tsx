...
import { subSuperScriptData } from './subSuperScriptData';
...
export const SubSuperScriptTools = (props: Props) => {
  ...
  return (
    <StyledToggleButtonGroup
      ...
      aria-label={t('subSuperScript.title')}
      size="small"
    >
      {subSuperScriptData.map(({ icon, ariaLabel, value }) => (
        <ToggleButton
          value={value}
